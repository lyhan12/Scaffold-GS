...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], ply_path=None):
        ...
        if os.path.basename(args.source_path) == "building-pixsfm" or os.path.basename(args.source_path) == "rubble-pixsfm":
            scene_info = sceneLoadTypeCallbacks["MegaNeRF"](args.source_path, args.images, args.eval, args.ds)
    ...
    def save(self, iteration):
        ...
        self.gaussians.save_ply(os.path.join(point_cloud_path, "point_cloud_scaffoldgs.ply"))
